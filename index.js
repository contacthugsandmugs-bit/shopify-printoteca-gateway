...
// (full Printoteca API access)
// ---------------------------

// List orders (proxy to GET /api/orders.php)
...
// Get single order (proxy to GET /api/order.php)
...
// Count orders (proxy to GET /api/orders/count.php)
...
// Delete order (proxy to "DELETE" behavior)
